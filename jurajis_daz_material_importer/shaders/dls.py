...
class DualLobeSpecularMaterialShader(MaterialShader):
    ...
    def create_node_group(self, node_trees: BlendDataNodeTrees):
        ...
        sock_out_specular = node_group.interface.new_socket(name='Specular', in_out='OUTPUT',
        ...
        node_dls_layer_weight.inputs[0].default_value = self.properties.dls_layer_factor
