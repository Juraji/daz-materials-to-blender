...
class DualLobeSpecularShaderGroupBuilder(ShaderGroupBuilder):
    ...
    def setup_group(self):
        ...
        # Nodes: Group Input
        node_group_input = self._add_node__group_input('Group Input', (-1180, 20.0))

        # Nodes: Dual Lobe Specular
        node_combine_weight = self._add_node__hsv('Combine Specular Weight', (-920, 0.0))
        ...
        node_combine_reflectivity = self._add_node__hsv('Combine Specular Reflectivity', (-920, -120.0))
        ...
        node_combine_l1_roughness = self._add_node__hsv('Combine Lobe 1 Roughness', (-920, -80.0))
        ...
        node_combine_l2_roughness_mult = self._add_node__hsv('Combine Specular Lobe 2 Roughness', (-920, -160.0))
        ...
        node_combine_ratio = self._add_node__hsv('Combine Dual Lobe Specular Ratio', (-920, -40.0))
        ...
        node_l1_multiply = self._add_node__mix("Lobe 1 Multiply", (-660, -40.0))
        ...
        node_l2_multiply = self._add_node__mix("Lobe 2 Multiply", (-660, -160.0))
        ...
        node_l1_glossy = self._add_node(ShaderNodeBsdfAnisotropic, "Lobe 1 Glossy", (-460, -80.0))
        ...
        node_l2_glossy = self._add_node(ShaderNodeBsdfAnisotropic, "Lobe 2 Glossy", (-460, -140.0))
        ...
        node_layer_weight = self._add_node(ShaderNodeLayerWeight, "Layer Weight", (-460, 0.0))
        ...
        node_mix_glossies = self._add_node__mix_shader("Mix Glossies", (-240, -100.0))
        ...
        node_layer_weight_factor = self._add_node(ShaderNodeMath, "Layer Weight Factor", (-240, 0.0))
